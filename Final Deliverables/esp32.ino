...
#define ORG "ede5q6"                        // IBM organisation id
#define DEVICE_TYPE "MyTesting"                // Device type mentioned in ibm watson iot platform
#define DEVICE_ID "12345"              // Device ID mentioned in ibm watson iot platform
#define TOKEN "lrTLbr*22xoKqc)Wko"          // Token
...
// payload += "\" }";
String payload="{\"data\":";
payload+="\"HighAlert !Trash bin is about to be full\"";
payload+="," "\"gap\":";
payload+=cm;
payload+="}";
Serial.print("\n");
...
String payload="{\"data\":";
payload+="\"warning! Trash is about to cross 50% of bin level\"";
payload+="," "\"gap\":";
payload+=cm;
payload+="}";
// String payload="";
// // String payload = "{\"warning! Trash is about to cross 50% of bin leve\":\"";
// payload += cm;
// payload += "\" }";
Serial.print("\n");
...
// String data="Bin is available";
// float gap=cm;
// String payload="{\Data"
// String data="{\"data\":\"Bin is available\" ,";
// String payload = "\"load\":\"";
String payload="{\"data\":";
payload+="\"Trash is in low level(Space available)\"";
payload+="," "\"gap\":";
payload+=cm;
payload+="}";
// payload += cm;
